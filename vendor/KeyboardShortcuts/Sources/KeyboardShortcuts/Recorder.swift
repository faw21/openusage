...
// Vendored patch: removed the `#Preview` blocks (Xcode-preview-only) so this package builds under the
// Command Line Tools toolchain, which ships no SwiftUI `#Preview` macro plugin.
#endif
